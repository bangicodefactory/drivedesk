    ...
    <script>
        <?php if(
            ...
            $(document).on("click", "#flutterwavePaymentBtn", function() {
                ...
                const amount = discoutedPrice.replace("$", "");

                if (amount) {
                    var API_publicKey = '<?php echo e($settings['flutterwave_public_key']); ?>';
                    var nowTim = "<?php echo e(date('d-m-Y-h-i-a')); ?>";
                    var flutter_callback = "<?php echo e(url('subscription/flutterwave/')); ?>";
                    var x = getpaidSetup({
                        PBFPubKey: API_publicKey,
                        customer_email: '<?php echo e(\Auth::user()->email); ?>',
                        amount: amount,
                        currency: '<?php echo e($settings['CURRENCY']); ?>',
                    ...
                    <table class="display dataTable cell-border ">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo e(__('Driver Limit')); ?></th>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><?php echo e($subscription->driver_limit); ?></td>
                                <td>
                ...
                <?php if(
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                                    ...
                                    <div class="setting-card action-menu">
                                        <div class="form-group">
                                            <div class="form-check custom-chek">
                                                ...
                                                <label class="form-check-label"
                                                    for="have_stripe_coupon"><?php echo e(__('Have a Discount
                                                                                            Coupon Code?')); ?>
                            ...
                            <div class="card-body profile-user-box">
                                <form
                                    action="<?php echo e(route('subscription.flutterwave', \Illuminate\Support\Facades\Crypt::encrypt($subscription->id))); ?>"
                                    class="require-validation" method="post" id="flutterwavePaymentForm">
                                    <?php echo csrf_field(); ?>
                                    <div class="row">
                                        <?php if($subscription->couponCheck() > 0): ?>
                                            <div class="col-md-12 d-none coupon_div">
                                                <div class="form-group">
                                                    <label for="card-name-on"
                                                        class="form-label text-dark"><?php echo e(__('Coupon
                                                                                                    Code')); ?></label>
                                                    <input type="text" name="coupon"
                                                        class="form-control required packageCouponCode"
                                                        placeholder="<?php echo e(__('Enter Coupon Code')); ?>">
                                        ...
                                        <div class="col-sm-12">
                                            <?php if($subscription->couponCheck() > 0): ?>
                                                <input type="button" value="<?php echo e(__('Coupon Apply')); ?>"
                                                    class="btn btn-warning packageCouponApplyBtn d-none coupon_div">
                                            <?php endif; ?>
                                            <input type="button" value="<?php echo e(__('Pay Now')); ?>" id="flutterwavePaymentBtn"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/directonderweg/resources/views/subscription/show.blade.php ENDPATH**/ ?>