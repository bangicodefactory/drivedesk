                    ...
                    <table class="display dataTable cell-border datatbl-advance" id="rentalTable_agreement">
                        ...
                        <?php $__currentLoopData = $agreements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $agreement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><?php echo e(dateFormatHourMinute($agreement->rental_start_date)); ?> </td>
                                <td><?php echo e(dateFormatHourMinute($agreement->rental_end_date)); ?> </td>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/car_directonderweg/resources/views/rental_agreement/index.blade.php ENDPATH**/ ?>