    ...
    <script>
        ...
        $(".customizer-modal").append('' +
            ...
            '</div>' +
                ...
                '<div class="cutomize-group"> ' +
                '<h6 class="customizer-title"><?php echo e(__('Owner Email Verification')); ?></h6> ' +
                '<div> <label class="switch with-icon switch-primary"><input type="checkbox" name="owner_email_verification" id="owner_email_verification" <?php echo e($settings['owner_email_verification'] == 'on' ? 'checked' : ''); ?>>' +
...
<!-- datetimepicker-->
<script src="<?php echo e(asset('assets/js/vendors/datetimepicker/jquery.datetimepicker.full.min.js')); ?>"></script>
...
<?php endif; ?>
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/car_directonderweg/resources/views/admin/footer.blade.php ENDPATH**/ ?>