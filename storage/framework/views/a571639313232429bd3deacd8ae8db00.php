            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="text-right">
                        ...
                        <a href="#" data-size="md" data-url="<?php echo e(route('setting.smtp.test')); ?>" data-title="<?php echo e(__('Add Email')); ?>"  class='btn btn-primary btn-rounded customModal'> <?php echo e(__('Test Mail')); ?> </a>
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/directonderweg/resources/views/settings/smtp.blade.php ENDPATH**/ ?>