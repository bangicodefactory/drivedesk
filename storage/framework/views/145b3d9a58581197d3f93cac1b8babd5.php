        ...
        <div class="row">
            ...
            <div class="col-6">
                <div class="detail-group">
                    ...
                    <p class="mb-20"><?php echo e(!empty($driver) && !empty($driver->birth_date)?dateFormat($driver->birth_date):'-'); ?> </p>
                </div>
            </div>
            <div class="col-6">
                <div class="detail-group">
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/directonderweg/resources/views/driver/show.blade.php ENDPATH**/ ?>