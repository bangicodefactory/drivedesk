...
<?php $__env->startSection('card-action-btn'); ?>
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create role')): ?>
        <a class="btn btn-primary btn-sm ml-20" href="<?php echo e(route('role.create')); ?>"> <i
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <div class="cart-action">
                                        ...
                                        <?php endif; ?>
                                        <?php if($role->name !='client' && $role->name !='driver'): ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/directonderweg/resources/views/role/index.blade.php ENDPATH**/ ?>