            ...
            <ul class="nav-iconlist">
                ...
                <li class="nav-profile">
                    ...
                    <div class="hover-dropdown navprofile-drop">
                        <ul>
                            <li><a href="<?php echo e(route('setting.account')); ?>"><i class="ti-user"></i><?php echo e(__('Profile')); ?></a>
                            </li>
                            <li>
...
<!-- Header End-->
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/car_directonderweg/resources/views/admin/header.blade.php ENDPATH**/ ?>