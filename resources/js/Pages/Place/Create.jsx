...
// depo_address). Posts to route('place.store'). The zod schema mirrors the
// controller's store() `required` rules (name|city|island|price) for UX only;
...
function PlaceCreate() {
    ...
    return (
        <div className="space-y-6 p-6">
            <Card>
                <CardHeader>
                    <CardTitle>{t('Create Place')}</CardTitle>
                </CardHeader>
                <CardContent>
                    <form onSubmit={submit('post', route('place.store'))}>
