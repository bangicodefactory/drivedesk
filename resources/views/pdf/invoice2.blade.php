...
<div class="container">
  ...
  <table width="100%">
    <tr>
      <td width="75px">
        <img src="{{ $logoPath }}" alt="Company Logo" class="logotype">
    </td>
      <td width="300px"><div style="background: #aedbfb;border-left: 15px solid #fff;padding-left: 30px;font-size: 26px;font-weight: bold;letter-spacing: -1px;height: 73px;line-height: 75px;">FACTURE</div></td>
      <td></td>
    </tr>
  </table> 
  <br><br>
    ...
    <tr>
        ...
        <table>
          <tr>
            <td style="vertical-align: text-top;">
              <div style="background: #aedbfb url(https://cdn0.iconfinder.com/data/icons/commerce-line-1/512/comerce_delivery_shop_business-07-128.png);width: 50px;height: 50px;margin-right: 10px;background-position: center;background-size: 42px;"></div>   
            </td>
            <td>
      ...
      <td>
        <table>
          <tr>
            <td style="vertical-align: text-top;">
              <div style="background: #aedbfb url(https://cdn4.iconfinder.com/data/icons/app-custom-ui-1/48/Check_circle-128.png) no-repeat;width: 50px;height: 50px;margin-right: 10px;background-position: center;background-size: 25px;"></div>   
            </td>
            <td>
              <strong>Delivery</strong><br>
              Firstname Lastname<br>
  ...
  <div style="background: #aedbfb url(https://cdn4.iconfinder.com/data/icons/basic-ui-2-line/32/shopping-cart-shop-drop-trolly-128.png) no-repeat;width: 50px;height: 50px;margin-right: 10px;background-position: center;background-size: 25px;float: left; margin-bottom: 15px;"></div> 
  <h3>Your articles</h3>
      ...
      <td>
        <table width="300px" style="float:right">
          ...
          <tr>
            ...
            <td style="text-align:right">31.25 SEK</td>
          </tr>
          <tr>
            <td><strong>Grand total:</strong></td>    
            <td style="text-align:right">187.50 SEK</td>
          </tr>
        </table>
       </td>
    </tr>
