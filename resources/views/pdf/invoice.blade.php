...
<html>
<head>
    <title>Invoice #{{ $invoice->facture_number }}</title>
    <style>
...
<body>
    <div class="title">Invoice #{{ $invoice->facture_number }}</div>
    <div class="section">Designation: {{ $invoice->designation }}</div>
    <div class="section">Date: {{ dateFormat($invoice->created_at) }}</div>
    <div class="section">Montant TTC: {{ $invoice->montant_ttc }} Dh</div>
</body>
</html> --}}
