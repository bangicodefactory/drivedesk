...
<section class="testimonial-section fix section-padding">
    ...
    <div class="container">
        <div class="section-title-area">
            ...
            <p class="wow fadeInUp" data-wow-delay=".5s">Lorem ipsum dolor sit amet nsectetur cing elituspe ndisse suscipit sagitis leo sit.</p>
        </div>
            ...
            <div class="swiper-wrapper">
                ...
                $testimonials = [
                    [
                        ...
                        'image' => 'client-1.png',
                        'rating' => 4,
                        'text' => 'I was very impressed by the remons service lorem ipsum is simply free text used by copy typing refreshing. Neque porro est qui dolorem ipsum quia.'
                    ],
                    [
                        'name' => 'Kevin Martin',
                        'role' => 'Customer',
                    ...
                    <div class="testimonial-card-items">
                        ...
                        <div class="client-info-items d-flex align-items-center gap-3">
                            <div class="client-thumb">
                                <img src="{{ asset('assets/images/client/testimonial/' . $testimonial['image']) }}" alt="{{ $testimonial['name'] }}">
                            </div>
