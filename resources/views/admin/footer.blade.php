    ...
    <script>
        ...
        $(".customizer-modal").append('' +
            ...
            '</div>' +
                ...
                '<div class="cutomize-group"> ' +
                '<h6 class="customizer-title">{{ __('Owner Email Verification') }}</h6> ' +
                '<div> <label class="switch with-icon switch-primary"><input type="checkbox" name="owner_email_verification" id="owner_email_verification" {{ $settings['owner_email_verification'] == 'on' ? 'checked' : '' }}>' +
...
<!-- datetimepicker-->
<script src="{{ asset('assets/js/vendors/datetimepicker/jquery.datetimepicker.full.min.js') }}"></script>
